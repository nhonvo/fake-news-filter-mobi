                          ...
                          child: SmartRefresher(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (_, index) => CardNews(
                                  newsId: viewmodel.newsLoadMore[index]!.newsId
                                      .toString(),
                                  factCheck: Images.icnone,
                                  rate: true,
                                  tags: viewmodel.newsLoadMore[index]!.topicInfo!
                                      .map((v) => v!.topicName)
                                      .toList(),
                                  socialBeliefs:
                                      '${viewmodel.newsLoadMore[index]!.socialBeliefs!.toInt() * 100}%',
                                  times: AppHelper.convertToAgo(DateTime.parse(
                                      viewmodel.newsLoadMore[index]!.timestamp
                                          .toString())),
                                  title: viewmodel.newsLoadMore[index]!.title
                                      .toString()
                                      .substring(
                                          0,
                                          viewmodel.newsLoadMore[index]!.title
                                                      .toString()
                                                      .length >
                                                  50
                                              ? 50
                                              : viewmodel
                                                  .newsLoadMore[index]?.title
                                                  .toString()
                                                  .length),
                                  ...
                                  onPress: () {
                                    viewmodel.handleGetCountView(
                                        viewmodel.newsLoadMore[index]!.newsId!);
                                  }),
                            ),
                          ),
                        ),
